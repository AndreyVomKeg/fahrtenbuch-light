...
function IcoBtn({color=C.muted, size=16, icon, onClick, title}) {
  ...
  const bg=pressed?(GLASS_MODE?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.14)"):hov?(GLASS_MODE?"rgba(0,0,0,0.05)":"rgba(0,0,0,0.08)"):"transparent";
  return (
...
function FormPanel({accent, title, icon, children, onSave}) {
  ...
  return (
    <div onKeyDown={handleKey} className={GLASS_MODE?"glass-card":undefined} style={{
      ...(GLASS_MODE?GLASS:{}),
...
function EmptyState({icon="car", text, hint, btnLabel, onBtnClick, accent=C.muted, accentDk}) {
  return (
    <div className={GLASS_MODE?"glass-card":undefined} style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",
...
function SectionBar({count, label, onAdd, accent, accentDk, addLabel, formOpen, noGlass}) {
  ...
  return (
    <div className={!noGlass&&GLASS_MODE?"glass-card":undefined} style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:noGlass?0:10,
...
function StandortePanel({aktiv, patchAktiv, setConfirmDel, setFData, setFForm, setTab, E_F}) {
  ...
  return (
    <div>
      ...
      {!!alle.length&&<div className={GLASS_MODE?"glass-card":undefined} style={{marginBottom:14,
...
function BaseModal({onClose, title, icon, accent=C.red, maxWidth=520, children}) {
  ...
  return (
    <div onClick={onClose} style={{
      ...
      background:GLASS_MODE?"rgba(0,0,0,0.45)":"rgba(15,15,15,0.50)",
      ...
      <div onClick={e=>e.stopPropagation()} style={{
        ...(GLASS_MODE?GLASS:{}),
        background:GLASS_MODE?'rgba(255,255,255,0.88)':C.surface,
        ...
        boxShadow:GLASS_MODE?'0 24px 64px rgba(0,0,0,0.12), inset 0 1px 0 rgba(255,255,255,0.8)':(isMobile?"none":"0 24px 64px rgba(0,0,0,0.20), 0 2px 8px rgba(0,0,0,0.08)"),
...
function UebersichtTab({stats, aktiv, acc, accDk, C, SANS, FS, katAccent, katAccentDk, setTab, setFForm, setFData, E_F, patchAktiv, safeFloat, formatDatum, getZielName, getZielAdr, isMobile, isTablet}) {
  ...
  return (
    ...
    <div className="glass-card" style={{...gls,background:glsBg,padding:isMobile?"14px 12px":"16px 18px",borderLeft:glsBl(C.steel),boxShadow:glsSh,borderRadius:glsR,overflow:"hidden",boxSizing:"border-box",display:"flex",flexDirection:"column"}}>
    ...
    <div className="glass-card" style={{...gls,background:glsBg,padding:isMobile?"14px 12px":"16px 18px",borderLeft:glsBl(C.red),boxShadow:glsSh,borderRadius:glsR}}>
    ...
    <div className="glass-card" style={{...gls,background:glsBg,padding:isMobile?"14px 12px":"16px 18px",borderLeft:glsBl(C.red),boxShadow:glsSh,borderRadius:glsR,marginBottom:isMobile?8:10}}>
    ...
    <div className="glass-card" style={{...gls,background:glsBg,padding:isMobile?"14px 12px":"16px 18px",borderLeft:glsBl(C.service),boxShadow:glsSh,borderRadius:glsR,overflow:"hidden",boxSizing:"border-box"}}>
    ...
    {/* Top Besucht */}
    <div className="glass-card" style={{...gls,background:glsBg,padding:isMobile?"14px 12px":"16px 18px",borderLeft:glsBl(C.red),boxShadow:glsSh,borderRadius:glsR,overflow:"hidden",boxSizing:"border-box"}}>
    ...
    {/* Letzte Fahrten */}
    <div className="glass-card" style={{...gls,background:glsBg,padding:isMobile?"14px 12px":"16px 18px",borderLeft:glsBl(C.red),boxShadow:glsSh,borderRadius:glsR,gridColumn:isMobile?"1":isTablet?"1 / -1":"auto",overflow:"hidden",boxSizing:"border-box"}}>
    ...
    {!aktiv.standort?.name&&(
    <div className="glass-card" style={{...gls,background:glsBg,borderTop:GLASS_MODE?`2px solid ${C.red}99`:`2px solid ${C.red}`,padding:isMobile?"10px 12px":"14px 18px",
    ...
    <div className="glass-card" style={{...gls,background:glsBg,borderTop:GLASS_MODE?`2px solid ${C.strafe}99`:`2px solid ${C.strafe}`,padding:isMobile?"10px 12px":"14px 18px",
    display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,flexWrap:"wrap",overflow:"hidden",boxSizing:"border-box",
    boxShadow:glsSh,borderRadius:glsR}}>
    ...
    <div className="glass-card" style={{...gls,background:glsBg,borderTop:GLASS_MODE?`2px solid ${C.service}99`:`2px solid ${C.service}`,padding:isMobile?"10px 12px":"14px 18px",
    display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,flexWrap:"wrap",overflow:"hidden",boxSizing:"border-box",
    boxShadow:glsSh,borderRadius:glsR}}>
...
function BerichtTab({gefFahrten, aktiv, acc, accDk, C, SANS, safeFloat, formatDatum,
  ...
  return (
    ...
    {/* Toolbar */}
    <div className={GLASS_MODE?"glass-card":undefined} style={{display:"flex",justifyContent:"flex-end",gap:8,marginBottom:14,
...
`}</style>
    <div style={{minHeight:"100vh",background:GLASS_MODE?GLASS_BG:C.bg,color:C.text,fontFamily:SANS,overflowX:"hidden",width:"100%",maxWidth:"100vw",position:"relative"}}>
      ...
      {/* ══ HEADER ══ */}
      <header ref={headerRef} data-nav="1" style={{background:GLASS_MODE?'rgba(255,255,255,0.88)':C.bg,backdropFilter:GLASS_MODE?'blur(24px) saturate(1.4)':undefined,WebkitBackdropFilter:GLASS_MODE?'blur(24px) saturate(1.4)':undefined,borderBottom:`0.5px solid ${GLASS_MODE?'rgba(221,221,216,0.6)':C.border}`,position:"fixed",top:0,left:0,right:0,zIndex:100,transition:"border-color 0.3s",boxShadow:'0 2px 8px rgba(0,0,0,0.10), 0 6px 24px rgba(0,0,0,0.06)'}}>
          ...
          {(()=>{const now=new Date();const nowYM=now.getFullYear()*12+now.getMonth();const parseTuv=d=>{if(!d)return null;if(d.includes(".")){const p=d.split(".").map(Number);return p.length>=3?{y:p[2],m:p[1]}:p.length===2?{y:p[1],m:p[0]}:null;}if(d.includes("-")){const[y,m]=d.split("-").map(Number);return{y,m};}return null;};const alertFz=[aktiv].filter(fz=>{const t=parseTuv(fz.tuvDatum);if(!t)return false;return(t.y*12+(t.m-1))-nowYM<=2;});const offeneStrafen=(aktiv.strafen||[]).filter(s=>!s.bezahlt);const totalAlerts=alertFz.length+offeneStrafen.length;if(!totalAlerts)return null;return(
              <div ref={tuvRef} style={{position:"relative"}}>
                <button onClick={()=>setTuvPopup(v=>!v)}
                  style={{width:40,height:40,background:tuvPopup?(GLASS_MODE?"rgba(0,0,0,0.05)":"rgba(0,0,0,0.08)"):"transparent",border:"none",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",position:"relative",transition:"background 0.12s",borderRadius:C.inputRadius||8}}
                  onMouseEnter={e=>{if(!tuvPopup)e.currentTarget.style.background=GLASS_MODE?"rgba(0,0,0,0.05)":"rgba(0,0,0,0.08)"}}
                  onMouseLeave={e=>{if(!tuvPopup)e.currentTarget.style.background="transparent"}}
                  onMouseDown={e=>e.currentTarget.style.background=GLASS_MODE?"rgba(0,0,0,0.08)":"rgba(0,0,0,0.14)"}
                  onMouseUp={e=>e.currentTarget.style.background=GLASS_MODE?"rgba(0,0,0,0.05)":"rgba(0,0,0,0.08)"}>
      ...
      <main key={tab+sub} style={{padding:isMobile?"12px 8px 24px":isTablet?"18px 16px 32px":"28px 32px 40px",maxWidth:1200,margin:"0 auto",animation:"tabFade 0.18s ease-out",overflowX:"hidden",boxSizing:"border-box",width:"100%"}}>
        ...
        {tab==="fahrten"&&(
          <div>
            ...
            <div className="glass-card" style={{marginBottom:isMobile?8:14,
          ...
          <div>
            ...
            {sub==="partner"&&(
              <div>
                ...
                {(aktiv.partner||[]).length>0&&<div className="glass-card" style={{marginBottom:14,
                  ...(GLASS_MODE?{background:GLASS.background,backdropFilter:GLASS.backdropFilter,WebkitBackdropFilter:GLASS.backdropFilter,borderRadius:12,border:GLASS.border,padding:'14px'}:{})
                }}>
          ...
          <div>
            ...
            {kostenSub==="tanken"&&(
              <div>
                ...
                {!!(aktiv.tankstellen||[]).length&&<div className="glass-card" style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10,...(GLASS_MODE?{background:GLASS.background,backdropFilter:GLASS.backdropFilter,WebkitBackdropFilter:GLASS.backdropFilter,borderRadius:12,border:GLASS.border,padding:"8px 14px"}:{})}}>
                  <div style={{fontSize:14,color:C.text}}>
            ...
            {kostenSub==="service"&&(
              <div>
                ...
                {!!(aktiv.services||[]).length&&<div className="glass-card" style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10,...(GLASS_MODE?{background:GLASS.background,backdropFilter:GLASS.backdropFilter,WebkitBackdropFilter:GLASS.backdropFilter,borderRadius:12,border:GLASS.border,padding:"8px 14px"}:{})}}>
                  <div style={{fontSize:14,color:C.text}}>
            ...
            {kostenSub==="waesche"&&(
              <div>
                ...
                {!!(aktiv.waesche||[]).length&&<div className="glass-card" style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10,...(GLASS_MODE?{background:GLASS.background,backdropFilter:GLASS.backdropFilter,WebkitBackdropFilter:GLASS.backdropFilter,borderRadius:12,border:GLASS.border,padding:"8px 14px"}:{})}}>
                  <div style={{fontSize:14,color:C.text}}>
            ...
            {kostenSub==="parken"&&(
              <div>
                ...
                {!!(aktiv.parkplaetze||[]).length&&<div className="glass-card" style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10,...(GLASS_MODE?{background:GLASS.background,backdropFilter:GLASS.backdropFilter,WebkitBackdropFilter:GLASS.backdropFilter,borderRadius:12,border:GLASS.border,padding:"8px 14px"}:{})}}>
                  <div style={{fontSize:14,color:C.text}}>
        ...
        {tab==="einstellungen"&&(
          <div style={{maxWidth:860}}>
            <div id="fz-block"/>
            <div className={GLASS_MODE?"glass-card":undefined} style={{display:"flex",alignItems:"center",gap:isMobile?10:16,marginBottom:10,padding:isMobile?'10px 12px':'12px 18px',...(GLASS_MODE?{...GLASS,borderRadius:12}:{})}}>
      ...
      {chatOpen && (
        <div style={{
          ...
          backdropFilter:GLASS_MODE?'blur(24px) saturate(1.4)':undefined,
          WebkitBackdropFilter:GLASS_MODE?'blur(24px) saturate(1.4)':undefined,
          border: isMobile ? "none" : GLASS_MODE?'1px solid rgba(255,255,255,0.5)':`1px solid ${C.border}`,
          borderRadius: isMobile ? 0 : isTablet ? 16 : 24,
          boxShadow: isMobile ? "none" : GLASS_MODE?"0 8px 40px rgba(0,0,0,0.08), inset 0 1px 0 rgba(255,255,255,0.7)":"0 8px 40px rgba(0,0,0,0.15), 0 2px 8px rgba(0,0,0,0.08)",
          display:"flex", flexDirection:"column",
