...
`}</style>
    <div style={{minHeight:"100vh",background:C.bg,color:C.text,fontFamily:SANS,marginRight:chatOpen?500:0,transition:"margin-right 0.35s cubic-bezier(0.4,0,0.2,1)"}}>
