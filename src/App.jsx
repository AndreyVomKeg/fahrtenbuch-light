...
`}</style>
    <div style={{minHeight:"100vh",background:GLASS_MODE?GLASS_BG:C.bg,color:C.text,fontFamily:SANS,overflowX:"hidden",width:"100%",maxWidth:"100vw",position:"relative"}}>
      ...
      {GLASS_MODE && <video autoPlay muted loop playsInline poster={BG_VIDEO_POSTER}
        style={{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",objectFit:"cover",zIndex:-1,pointerEvents:"none",filter:"brightness(1.12) contrast(0.52) saturate(1.2) url(#illustrated)",transform:"scale(1.03)"}}>
