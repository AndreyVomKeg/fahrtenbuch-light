...
function FahrtenbuchApp({authUser, onLogout, themeId, setThemeId}) {
  ...
  const DATA_MIGRATIONS = [
    ...
    // v22: TF-VG 2016 — 2 Service-Einträge 2025 + Werkstatt Standort
    { v:22, run: fzs => fzs.map(f => {
      if(f.kennzeichen !== "TF-VG 2016") return f;
      const svcs = f.services||[];
      const hasSvc = svcs.some(s=>s.datum==="2025-06-06"&&s.kmStand==="76583");
      const newSvcs = hasSvc ? svcs : [...svcs,
        {id:uid(),datum:"2025-06-06",typ:"Inspektion",werkstatt:"KfZ-Meisterbetrieb Klaus & Mike",adresse:"Ruhlsdorfer Str. 100, 14513 Teltow",kmStand:"76583",betrag:"",rechnungsNr:"",faelligKm:"",faelligDatum:"",zahlungsart:"",notiz:"Inspektion + Ölwechsel",belegFoto:""},
        {id:uid(),datum:"2025-12-08",typ:"Inspektion",werkstatt:"KfZ-Meisterbetrieb Klaus & Mike",adresse:"Ruhlsdorfer Str. 100, 14513 Teltow",kmStand:"81015",betrag:"",rechnungsNr:"",faelligKm:"",faelligDatum:"",zahlungsart:"",notiz:"Inspektion",belegFoto:""},
      ];
      const extra = f.standorteExtra||[];
      const hasWerkstatt = extra.some(s=>(s.name||"").toLowerCase().includes("klaus & mike"));
      const newExtra = hasWerkstatt ? extra : [...extra,
        {id:uid(),name:"KfZ-Meisterbetrieb Klaus & Mike",adresse:"Ruhlsdorfer Str. 100, 14513 Teltow",notiz:"Werkstatt TF-VG 2016",auto:false,typ:"werkstatt",besuche:2,letzterBesuch:"2025-12-08",kmVonStandort:"20"},
      ];
      return {...f, services:newSvcs, standorteExtra:newExtra};
    }) },
    // v23: TF-VG 2016 — 9 Tankstellen 2025 + neue Standorte (Läden, Tankstellen)
    { v:23, run: fzs => fzs.map(f => {
      if(f.kennzeichen !== "TF-VG 2016") return f;
      const tanks = f.tankstellen||[];
      const hasTanks = tanks.some(t=>t.datum==="2025-06-21"&&t.gesamtbetrag==="93.50");
      const newTanks = hasTanks ? tanks : [...tanks,
        {id:uid(),datum:"2025-06-21",uhrzeit:"09:28",stationName:"ARAL - REWE To Go",adresse:"Hohenzollerndamm 97, 14199 Berlin",kraftstoff:"Super E10",menge:"55.03",preisProLiter:"1.699",gesamtbetrag:"93.50",kmStand:"",zahlungsart:"EC-Karte",bonNr:"",notiz:"",kmVonStandort:"38"},
        {id:uid(),datum:"2025-06-22",uhrzeit:"12:21",stationName:"ENI Deutschland GmbH",adresse:"BAB 9 Richtung München, 90537 Nürnberg-Feucht",kraftstoff:"Super E10",menge:"46.78",preisProLiter:"2.219",gesamtbetrag:"103.80",kmStand:"",zahlungsart:"EC-Karte",bonNr:"",notiz:"Autobahn A9",kmVonStandort:""},
        {id:uid(),datum:"2025-06-27",uhrzeit:"13:03",stationName:"Tankstelle Forster",adresse:"BAB 9 Fürholzen Ost, 85376 Fürholzen",kraftstoff:"Super E10",menge:"41.66",preisProLiter:"2.199",gesamtbetrag:"91.61",kmStand:"",zahlungsart:"EC-Karte",bonNr:"",notiz:"Autobahn A9",kmVonStandort:""},
        {id:uid(),datum:"2025-06-27",uhrzeit:"16:48",stationName:"ENI Service Station",adresse:"An der BAB 9, 07927 Hirschberg",kraftstoff:"Super E10",menge:"31.75",preisProLiter:"1.989",gesamtbetrag:"63.15",kmStand:"",zahlungsart:"EC-Karte",bonNr:"",notiz:"Autobahn A9, Rückfahrt",kmVonStandort:""},
      ...
      const extra = f.standorteExtra||[];
      const newStandorte = [
        {name:"ARAL - REWE To Go",adresse:"Hohenzollerndamm 97, 14199 Berlin",notiz:"Tankstelle + REWE",typ:"tankstelle",besuche:3,letzterBesuch:"2025-11-21",kmVonStandort:"38"},
        {name:"Sprint Tankstelle Wildau",adresse:"Chausseestr. 1, 15745 Wildau",notiz:"Tankstelle",typ:"tankstelle",besuche:1,letzterBesuch:"2025-09-04",kmVonStandort:"25"},
        {name:"Kaufland Wildau",adresse:"Chausseestraße 1, 15745 Wildau",notiz:"Supermarkt",typ:"laden",besuche:2,letzterBesuch:"2025-11-07",kmVonStandort:"25"},
        {name:"Kaufland Ludwigsfelde",adresse:"Potsdamer Straße 51-53, 14974 Ludwigsfelde",notiz:"Supermarkt",typ:"laden",besuche:1,letzterBesuch:"2025-12-01",kmVonStandort:"3"},
        {name:"Blumen-Koch",adresse:"Westfälische Str. 38, 10711 Berlin",notiz:"Blumenladen",typ:"laden",besuche:1,letzterBesuch:"2025-10-22",kmVonStandort:"38"},
        {name:"Blume 2000",adresse:"Breite Straße 14a, 14199 Berlin",notiz:"Blumenladen",typ:"laden",besuche:1,letzterBesuch:"2025-11-07",kmVonStandort:"38"},
        {name:"Berliner Schlüsseldienst",adresse:"Konstanzer Str. 50, 10707 Berlin",notiz:"Schlüssel / Schlösser",typ:"laden",besuche:1,letzterBesuch:"2025-11-21",kmVonStandort:"38"},
      ];
      let newExtra = [...extra];
      for(const s of newStandorte) {
        if(!newExtra.some(e=>(e.name||"").toLowerCase()===s.name.toLowerCase())) {
          newExtra.push({id:uid(),auto:false,...s});
        }
      }
      return {...f, tankstellen:newTanks, standorteExtra:newExtra};
    }) },
    // v24: re-apply v22+v23 for TF-VG 2016 (safety re-run)
    { v:24, run: fzs => fzs.map(f => {
      if(f.kennzeichen !== "TF-VG 2016") return f;
      // Services
      const svcs = f.services||[];
      if(!svcs.some(s=>s.datum==="2025-06-06"&&s.kmStand==="76583")) {
        svcs.push(
          {id:uid(),datum:"2025-06-06",typ:"Inspektion",werkstatt:"KfZ-Meisterbetrieb Klaus & Mike",adresse:"Ruhlsdorfer Str. 100, 14513 Teltow",kmStand:"76583",betrag:"",rechnungsNr:"",faelligKm:"",faelligDatum:"",zahlungsart:"",notiz:"Inspektion + Ölwechsel",belegFoto:""},
          {id:uid(),datum:"2025-12-08",typ:"Inspektion",werkstatt:"KfZ-Meisterbetrieb Klaus & Mike",adresse:"Ruhlsdorfer Str. 100, 14513 Teltow",kmStand:"81015",betrag:"",rechnungsNr:"",faelligKm:"",faelligDatum:"",zahlungsart:"",notiz:"Inspektion",belegFoto:""},
        );
      ...
      // Tankstellen
      const tanks = f.tankstellen||[];
      if(!tanks.some(t=>t.datum==="2025-06-21"&&(t.gesamtbetrag==="93.50"||t.gesamtbetrag===93.5))) {
        tanks.push(
          {id:uid(),datum:"2025-06-21",uhrzeit:"09:28",stationName:"ARAL - REWE To Go",adresse:"Hohenzollerndamm 97, 14199 Berlin",kraftstoff:"Super E10",menge:"55.03",preisProLiter:"1.699",gesamtbetrag:"93.50",kmStand:"",zahlungsart:"EC-Karte",bonNr:"",notiz:"",kmVonStandort:"38"},
          {id:uid(),datum:"2025-06-22",uhrzeit:"12:21",stationName:"ENI Deutschland GmbH",adresse:"BAB 9 Richtung München, 90537 Nürnberg-Feucht",kraftstoff:"Super E10",menge:"46.78",preisProLiter:"2.219",gesamtbetrag:"103.80",kmStand:"",zahlungsart:"EC-Karte",bonNr:"",notiz:"Autobahn A9",kmVonStandort:""},
          {id:uid(),datum:"2025-06-27",uhrzeit:"13:03",stationName:"Tankstelle Forster",adresse:"BAB 9 Fürholzen Ost, 85376 Fürholzen",kraftstoff:"Super E10",menge:"41.66",preisProLiter:"2.199",gesamtbetrag:"91.61",kmStand:"",zahlungsart:"EC-Karte",bonNr:"",notiz:"Autobahn A9",kmVonStandort:""},
      ...
      // Standorte
      const extra = f.standorteExtra||[];
      const addIfMissing = (name,obj) => { if(!extra.some(e=>(e.name||"").toLowerCase()===name.toLowerCase())) extra.push({id:uid(),auto:false,...obj}); };
      addIfMissing("KfZ-Meisterbetrieb Klaus & Mike",{name:"KfZ-Meisterbetrieb Klaus & Mike",adresse:"Ruhlsdorfer Str. 100, 14513 Teltow",notiz:"Werkstatt TF-VG 2016",typ:"werkstatt",besuche:2,letzterBesuch:"2025-12-08",kmVonStandort:"20"});
      addIfMissing("ARAL - REWE To Go",{name:"ARAL - REWE To Go",adresse:"Hohenzollerndamm 97, 14199 Berlin",notiz:"Tankstelle + REWE",typ:"tankstelle",besuche:3,letzterBesuch:"2025-11-21",kmVonStandort:"38"});
      addIfMissing("Sprint Tankstelle Wildau",{name:"Sprint Tankstelle Wildau",adresse:"Chausseestr. 1, 15745 Wildau",notiz:"Tankstelle",typ:"tankstelle",besuche:1,letzterBesuch:"2025-09-04",kmVonStandort:"25"});
      addIfMissing("Kaufland Wildau",{name:"Kaufland Wildau",adresse:"Chausseestraße 1, 15745 Wildau",notiz:"Supermarkt",typ:"laden",besuche:2,letzterBesuch:"2025-11-07",kmVonStandort:"25"});
      addIfMissing("Kaufland Ludwigsfelde",{name:"Kaufland Ludwigsfelde",adresse:"Potsdamer Straße 51-53, 14974 Ludwigsfelde",notiz:"Supermarkt",typ:"laden",besuche:1,letzterBesuch:"2025-12-01",kmVonStandort:"3"});
      addIfMissing("Blumen-Koch",{name:"Blumen-Koch",adresse:"Westfälische Str. 38, 10711 Berlin",notiz:"Blumenladen",typ:"laden",besuche:1,letzterBesuch:"2025-10-22",kmVonStandort:"38"});
      addIfMissing("Blume 2000",{name:"Blume 2000",adresse:"Breite Straße 14a, 14199 Berlin",notiz:"Blumenladen",typ:"laden",besuche:1,letzterBesuch:"2025-11-07",kmVonStandort:"38"});
      addIfMissing("Berliner Schlüsseldienst",{name:"Berliner Schlüsseldienst",adresse:"Konstanzer Str. 50, 10707 Berlin",notiz:"Schlüssel / Schlösser",typ:"laden",besuche:1,letzterBesuch:"2025-11-21",kmVonStandort:"38"});
      return {...f, services:svcs, tankstellen:tanks, standorteExtra:extra};
    }) },
    // v25: TF-VG 2016 — patch menge+preisProLiter+notiz on existing tankstellen
    { v:25, run: fzs => fzs.map(f => {
      if(f.kennzeichen !== "TF-VG 2016") return f;
      const patchMap = {
        "2025-06-21|93.50": {menge:"55.03",preisProLiter:"1.699"},
        "2025-06-22|103.80":{menge:"46.78",preisProLiter:"2.219"},
        "2025-06-27|91.61": {menge:"41.66",preisProLiter:"2.199"},
        "2025-06-27|63.15": {menge:"31.75",preisProLiter:"1.989"},
        "2025-08-22|80.52": {menge:"49.43",preisProLiter:"1.629"},
        "2025-09-04|40.00": {menge:"24.26",preisProLiter:"1.649"},
        "2025-09-14|122.16":{menge:"54.56",preisProLiter:"2.239"},
        "2025-11-21|115.19":{menge:"53.74",preisProLiter:"1.939",notiz:"Inkl. Aral Klare Sicht 10,99 € (Scheibenwischwasser)"},
        "2025-11-22|47.18": {menge:"26.08",preisProLiter:"1.809"},
      };
      const tanks = (f.tankstellen||[]).map(t => {
        const key = t.datum+"|"+t.gesamtbetrag;
        const patch = patchMap[key];
        if(patch && (!t.menge || t.menge==="")) return {...t, ...patch};
        return t;
      });
      return {...f, tankstellen:tanks};
    }) },
  ];
